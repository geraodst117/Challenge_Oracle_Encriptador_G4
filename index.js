...
buttonCopiar = document.getElementsByClassName("button-copy");
...
function verificarTexto() {
  ...
  let existetilde = texto_array.find((element) =>
    /^[\u00C0-\u017F]+$/.test(element)
  );
...
function mostrarMensajeNoEncontrado() {
  ...
  texto_salida.style.background = "url(./img/AluraSearch.png) no-repeat center";
  buttonCopiar[0].style.display = "none";
}
